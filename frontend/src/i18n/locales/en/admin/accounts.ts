export default {
    accounts: {
      ...
      upstreamGroupPlaceholder: 'default / vip',
      upstreamGroupHint: 'The group this sk- key is bound to on the upstream NewAPI, used to auto-resolve the latest group ratio on the providers page',
      expiresAt: 'Expires At',
