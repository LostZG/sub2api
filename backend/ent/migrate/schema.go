...
var (
	...
	AccountsColumns = []*schema.Column{
		...
		{Name: "upstream_group", Type: field.TypeString, Nullable: true, Size: 100},
		{Name: "status", Type: field.TypeString, Size: 20, Default: "active"},
	...
	ChannelProvidersColumns = []*schema.Column{
		...
		{Name: "group_ratio", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "group_ratio_checked_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
	}
